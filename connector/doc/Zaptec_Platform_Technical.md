...
Data polling configuration table is available to fine-tune polling intervals and control which data sets are retrieved, allowing operators to balance data retrival against API fair use limits.